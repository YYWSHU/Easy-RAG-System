...
# --- 配置 ---
html_directory = 'C:/Users/29184\Desktop/test4\leuka_data\html' # **** 修改为你的 HTML 文件夹路径 ****
output_json_path = 'C:/Users/29184\Desktop/test4\processed_data.json' # **** 输出 JSON 文件路径 ****
