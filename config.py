...
# Data Configuration
DATA_FILE ="C:/Users/29184\Desktop\sjwj\exp04-easy-rag-system\data\processed_bert1.json"

# Model Configuration
# Example: 'all-MiniLM-L6-v2' (dim 384), 'pritamdeka/S-PubMedBert-MS-MARCO' (dim 768)
